...
_resetFrame() {
    ...
    const viewMatrix = this._VROn ? (this.right ? this._VRAnimator.transform2.inverseGlobalMatrix : this._VRAnimator.transform.inverseGlobalMatrix) : this._camera.transform.inverseGlobalMatrix;
